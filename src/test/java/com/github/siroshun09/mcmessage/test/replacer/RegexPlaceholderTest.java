...
import com.github.siroshun09.mcmessage.replacer.RegexPlaceholder;
...
class RegexPlaceholderTest {

    private static final RegexPlaceholder PLACEHOLDER_A = RegexPlaceholder.create(Pattern.compile("(?i)§[0-9A-FK-ORX]"));
    private static final RegexPlaceholder PLACEHOLDER_B = RegexPlaceholder.create(Pattern.compile("(?i)&[0-9A-FK-ORX]"));
    private static final RegexPlaceholder PLACEHOLDER_A_2 = RegexPlaceholder.create(Pattern.compile("(?i)§[0-9A-FK-ORX]"));
    private static final String REPLACEMENT = "REPLACED";
    private static final String ORIGINAL = "Original ";
    private static final String ORIGINAL_A = ORIGINAL + "§3";
    private static final String ORIGINAL_A_B = ORIGINAL_A + "&A";
    ...
    void testEquals() {
        ...
        var placeholder_a_3 = Placeholder.create("(?i)§[0-9A-FK-ORX]");
    ...
    void testNullArguments() {
        Assertions.assertThrows(Throwable.class, () -> RegexPlaceholder.create((String) null));
        Assertions.assertThrows(Throwable.class, () -> RegexPlaceholder.create((Pattern) null));
    ...
    void testInvalidRegex() {
        Assertions.assertThrows(PatternSyntaxException.class, () -> RegexPlaceholder.create("BOOM\\"));
    }
}
